...
<div class="container mx-auto">
   <div class="max-w-xl mx-auto">
       <div class="bg-white rounded-lg shadow-lg p-6">
           <h2 class="text-2xl font-semibold mb-6">Tambah Kendaraan Baru</h2>
           ...
           <form action="{{ route('admin.vehicles.store') }}" method="POST">
               ...
               <div class="mb-4">
                   ...
                   <input type="text" name="vehicle_number" id="vehicle_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required value="{{ old('vehicle_number') }}">
               ...
               <div class="mb-4">
                   ...
                   <select name="type" id="type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                       ...
                       <option value="passenger" {{ old('type') == 'passenger' ? 'selected' : '' }}>Angkutan Orang</option>
                       <option value="cargo" {{ old('type') == 'cargo' ? 'selected' : '' }}>Angkutan Barang</option>
                   </select>
                   @error('type')
                       <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                   @enderror
               ...
               <div class="mb-4">
                   ...
                   <input type="text" name="brand" id="brand" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required value="{{ old('brand') }}">
                   @error('brand')
                       <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                   @enderror
               </div>
               ...
               <div class="mb-4">
                   ...
                   <input type="text" name="model" id="model" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required value="{{ old('model') }}">
                   @error('model')
                       <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                   @enderror
               </div>
               ...
               <div class="mb-4">
                   ...
                   <input type="number" name="capacity" id="capacity" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required value="{{ old('capacity') }}">
                   @error('capacity')
                       <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                   @enderror
               </div>
